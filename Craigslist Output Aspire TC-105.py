...
class Pythonwebdriverselenium(unittest.TestCase):
	...
	def test_pythonwebdriverselenium(self):
		...
		driver.find_element_by_xpath("(//input[@name='id'])[6]").click()
		driver.find_element_by_xpath("(//input[@name='id'])[20]").click()
		driver.find_element_by_name("n").click()
		driver.find_element_by_id("FromEMail").clear()
		driver.find_element_by_id("FromEMail").send_keys("")
		driver.find_element_by_id("ConfirmEMail").clear()
		driver.find_element_by_id("ConfirmEMail").send_keys("")
		...
		driver.find_element_by_id("contact_phone").send_keys("")
		driver.find_element_by_id("contact_name").clear()
		driver.find_element_by_id("contact_name").send_keys("")
		...
		driver.find_element_by_id("Ask").send_keys("")
